...
class UserController extends Controller
{
    ...
    public function completeEvent(Request $request){
        ...
        if(isset($request['later']) && $request['later']==true){
                ...
                if($profile_employee && $profile_employee->notifications==1){
                ...
                if($profile_user && $profile_user->notifications==1){
        ...
        if(isset($request['later']) && $request['later']==false){
            ...
            try {
                ...
                if($profile && $profile->notifications==1){
                ...
                if($employee_profile && $employee_profile->gcalendar && $employee_profile->access_token!=''){
