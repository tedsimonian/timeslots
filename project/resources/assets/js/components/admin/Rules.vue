...
<script>
    ...
    export default{
        ...
        mounted(){
            ...
            axios.get('/admin/get-employee-calendar/'+this.id).
            then(response=>{
        ...
        methods:{
            ...
            getDaysMarkers(){
                ...
                axios.get('/admin/get-employee-days-markers/'+this.id+'?rules=1').
                then(response=>{
            ...
            getSchedule(){
                ...
                axios.get('/admin/get-employee-schedule/'+this.id).
                then(response=>{
            ...
            getSpecialSchedule(date){
                ...
                axios.get('/admin/get-employee-special-schedule/'+this.id+'?day='+new_date).
                then(response=>{
            ...
            onSubmit(){
                ...
                let that=this;
                this.form.post('/admin/calendar-employee-settings/'+this.id,false)
                    .then(status=>{
            ...
            onSubmitSchedule(){
                ...
                this.form_days.post('/admin/save-employee-schedule/'+this.id,false)
                    .then(status=>{
            ...
            onSubmitSpecialSchedule(){
                ...
                let that=this;
                this.form_specific_days.post('/admin/save-employee-special-schedule/'+this.id,false)
                    .then(status=>{
