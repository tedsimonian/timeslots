                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control custom-select" v-model="employee" @change="loadCalendar">
    ...
    export default{
        ...
        data(){
            ...
            return {
                ...
                minDate:new Date(),
                event:new Form({employee_id:'',user:{},day:'',timeslot:'',duration:'',price:''}),
                eventCustom:new Form({employee_id:'',day:'',start:'',end:'',title:'',color:'#DC2127',description:''}),
        ...
        methods:{
            ...
            loadCalendar(){
                ...
                axios.get('/admin/get-employee-calendar/'+this.employee).
                then(response=>{
            ...
            createAppointment(){
                ...
                this.event.day=date;
                this.event.employee_id=this.employee;
                this.event.timeslot=this.form_selected_days.selected[0];
                this.event.post('/admin/create-appointment',false)
                    .then(status=>{
            ...
            createEvent(){
                ...
                this.eventCustom.employee_id=this.employee;
                ...
                this.eventCustom.post('/admin/create-event',false)
                    .then(status=>{
            ...
            searchUser (searchText) {
                ...
                axios.get('/admin/employee-get-users').
                then(response=>{
            ...
            getCalendarAvailability(){
                ...
                axios.get('/admin/get-employee-calendar-availability/'+this.employee).
                then(response=>{
            ...
            getHourSchedule(date){
                ...
                axios.get('/admin/get-employee-hour-availability/'+this.employee+'?day='+new_date+'&weekday='+weekday+'&increment='+this.increment+'&event_duration='+this.event_duration+'&today='+today).
                then(response=>{
            ...
            getDaysMarkers(){
                ...
                let today=moment().format('YYYY-MM-DD H:mm');
                axios.get('/admin/get-employee-days-markers/'+this.employee+'?increment='+this.increment+'&event_duration='+this.event_duration+'&today='+today+'&rules=0').
                then(response=>{
            ...
            getEvents(date){
                ...
                let new_date=moment(date).format('YYYY-MM-DD');
                axios.get('/admin/get-employee-events/'+this.employee+'?day='+new_date).
                then(response=>{
