            ...
            <div class="form-group" :class="{'has-danger':form.errors.has('postal_code')}">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group" :class="{'has-danger':form.errors.has('gcalendar')}">
                        <label class="col-md-12" >Google Calendar Integration</label>
                        <div class="col-md-12">
                            <div class="checkbox checkbox-success">
    ...
    export default{
        ...
        data(){
            ...
            return {
                ...
                address:'',city:'',state:'',postal_code:'',notifications:false,gcalendar:false}),
                user_id:this.id
        ...
        methods:{
            ...
            onSubmit(){
                ...
                this.form.patch('/admin/update-user/'+this.user_id,false)
                    .then(status=>{
